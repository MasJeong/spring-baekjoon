package springbasic.web.coreproject.order;
...
import springbasic.web.auditing.domain.BaseDomain;
...
public class CheckOut extends BaseDomain implements Serializable, Persistable<CheckOutPK> {
    ...
    @GenericGenerator(name = "sequential", strategy = "springbasic.web.util.UUIDUtil")
    @Column(name = "ID")
